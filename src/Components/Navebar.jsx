  ...
  return (
    <>
      <div className='container bg-white h-screen w-3/12 ml-3'>
          ...
          <a href="/StudentData">  <div className=' bg-black text-white rounded-full p-4 text-center w-5/6 m-auto hover:bg-[#FD7401]'> Students Data </div></a>
          <a href="/CertificateData">  <div className='  bg-black text-white rounded-full p-4 text-center w-5/6 m-auto hover:bg-[#FD7401]'>Certificate's Data</div></a>
